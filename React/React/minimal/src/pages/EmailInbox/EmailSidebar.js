        ...
        <div className="p-4 d-flex flex-column h-100">
          ...
          >
            <div className="mail-list mt-3">
              <Link to="#" className="active"><i className="ri-mail-fill me-3 align-middle fw-medium"></i> <span className="mail-list-link">All</span> <span className="badge badge-soft-success ms-auto  ">5</span></Link>
              <Link to="#"><i className="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> <span className="mail-list-link">Inbox</span> <span className="badge badge-soft-success ms-auto  ">5</span></Link>
            ...
            <div>
              ...
              <Link to="#"><span className="ri-checkbox-blank-circle-line me-2 text-info"></span><span className="mail-list-link" data-type="label">Support</span> <span className="badge badge-soft-success ms-auto">3</span></Link>
              ...
              <Link to="#"><span className="ri-checkbox-blank-circle-line me-2 text-danger"></span><span className="mail-list-link" data-type="label">Friends</span><span className="badge badge-soft-success ms-auto">2</span></Link>

                                    ...
                                    <Row>
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0">
                                                    <li className="p-0 parent-title"><Link to="#" className="fw-semibold fs-14">Nancy Martino - Project Director</Link></li>
                                                    <ul>
                                                        <li>
                                                            <Link to="#" className="fw-semibold">Erica Kernan - Team Leader</Link>
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-semibold">Mary Jones - Project Manager</Link>
                                                            <ul className="second-list">
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-semibold">Tilly Kent - Executive Manager</Link>
                                                            <ul>
                                                                <li>
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-semibold">Rachel Rose - HR</Link>
                                                        </li>
                                                    </ul>
                                                </ul>
                                            </div>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0">
                                                    <li className="p-0 parent-title"><Link to="#" className="fw-semibold fs-14">Velzon</Link></li>
                                                    <ul>
                                                        <li>
                                                            <Link to="#" className="fw-semibold text-primary"><i className="ri-airplay-line me-1 align-bottom"></i> Dashboards</Link>
                                                            <ul className="second-list">
                                                                <li>
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-semibold text-primary"><i className="ri-pencil-ruler-2-line me-1 align-bottom"></i> App Pages</Link>
                                                            <ul className="second-list">
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-semibold text-primary"><i className="ri-file-list-3-line me-1 align-bottom"></i> Pages</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="#" className="fw-semibold text-primary"><i className="ri-stack-line me-1 align-bottom"></i> Components</Link>
                                                            <ul>
                                                                <li>
